...
// Generate hash from given string and return it
...
// Decode given hash string and return values
...
// Compare given password and encoded hash, return true if they match, false otherwise
